...
// Route integration test for POST /api/breaks/[id]/lock.
...
// any spot-lock work. Mock the deps so the module imports cleanly; we pin the
// fail-closed admin guard.

vi.mock("@/lib/supabase", () => ({ supabaseAdmin: {} }))
vi.mock("@/lib/breaks/draft-shuffle", () => ({ CANONICAL_NBA_TEAMS: [] }))
...
function req(auth?: string): NextRequest {
  ...
  return new NextRequest("https://t/api/breaks/b1/lock", { method: "POST", headers })
}
