...
describe("buildSeasonStatsTables", () => {
  ...
  it("season labels: NBA is the two-year form, NFL the year; team slugs read as names", () => {
    ...
    // 2026-09-25: ESPN's slug for the Clippers is la-clippers — an initialism, so "LA", never "La" (read live on Paul Pierce's page)
    expect(teamSlugLabel("la-clippers")).toBe("LA Clippers")
    expect(teamSlugLabel("los-angeles-lakers")).toBe("Los Angeles Lakers")
