 ...
 */
// 8 → 6 → 5 (2026-08-22): `/[collection]/hot-floors`, `/[collection]/challenges`
// and `/analytics/wallets` had their single read extracted into
// `lib/hot-floors/fetchers.ts`, `lib/challenges/hub-fetchers.ts` and
// `lib/analytics/wallet-directory.ts` — taking the `@/lib/supabase` import out of
// a page is what removes it from this list.
