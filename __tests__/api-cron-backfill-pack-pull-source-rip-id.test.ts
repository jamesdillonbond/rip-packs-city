...
// Route integration test for POST /api/cron/backfill-pack-pull-source-rip-id.
...
const req = (auth?: string) =>
  ({
    ...
    nextUrl: new URL("https://t/api/cron/backfill-pack-pull-source-rip-id"),
  }) as any

import { POST } from "@/app/api/cron/backfill-pack-pull-source-rip-id/route"
