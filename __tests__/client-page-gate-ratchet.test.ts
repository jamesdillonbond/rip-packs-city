...
/* 19 -> 17: `[collection]/packs/simulator/[distId]` and `dashboard/api-keys` moved into
...
/* 17 -> 15: `admin/rewards` and `nba/fast-break` moved into `AdminRewardsClient.tsx` /
...
/* 13 -> 11: `dashboard/alerts` and `[collection]/profile/[username]` moved into
...
/* 9 -> 8: `admin/allow-list` moved into `AdminAllowListClient.tsx`, covered by
