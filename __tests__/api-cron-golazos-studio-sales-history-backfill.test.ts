...
// Route integration test for POST /api/cron/golazos-studio-sales-history-backfill.
...
// returning 401 before any drain. We pin that guard.
...
import { POST } from "@/app/api/cron/golazos-studio-sales-history-backfill/route"
...
describe("POST /api/cron/golazos-studio-sales-history-backfill", () => {
