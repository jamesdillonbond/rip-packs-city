...
// INGEST_SECRET_TOKEN gated → fail-closed 401. The UFC Cadence walk + enrichment
// chain run in after() (stubbed no-op) so the fire-and-forget accept (202) is
// observable; resolveWalletInput short-circuits for a valid 0x address. Mocks
...
const url = "https://t/api/wallet-backfill-ufc"
...
describe("POST /api/wallet-backfill-ufc — secret configured (success + body guards)", () => {
