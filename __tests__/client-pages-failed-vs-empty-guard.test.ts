...
describe("client pages — a failed read is not an empty result", () => {
  ...
  // ── SITE 4 (retired 2026-09-25): /panini-blockchain/sniper was DELETED when Panini
  // published on the shared [collection] routes — its OpenSea bridge-plane sniper had no
  // data RPC ingests (#64). /panini-blockchain/sniper now 307s to the overview
  // (proxy.ts RETIRED_COLLECTION_TABS). Nothing left here to pin.
