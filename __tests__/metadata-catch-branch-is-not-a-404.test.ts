...
function stripComments(s: string): string {
  // Required, not tidiness. This file's own fixes are explained by comments that
  // NAME the forbidden constant, and the pages themselves carry comments quoting
  // the shape they must not use. CLAUDE.md records this trap biting four times.
