...
// Route integration test for POST /api/cron/evm-transfers-ingest.
// Two-stage fail-closed guard (read at call time): 500 if INGEST_SECRET_TOKEN is
// unset (server misconfigured), else 401 on a missing/wrong Bearer or ?token=
// before any ingest. We pin both.
...
import { POST } from "@/app/api/cron/evm-transfers-ingest/route"

beforeEach(() => {
  process.env.INGEST_SECRET_TOKEN = "test-ingest-secret"
})

describe("POST /api/cron/evm-transfers-ingest", () => {
