...
export type League = "NBA" | "WNBA" | "NFL" | "LALIGA" | "MLB";
...
export const LEAGUES: ReadonlyArray<{ value: League; label: string; emoji: string }> = [
  ...
  // MLB added 2026-09-23 for franchise hubs — Candy MLB carries all 30 clubs.
  { value: "MLB",    label: "MLB",     emoji: "⚾" },
];

export function isLeague(value: unknown): value is League {
  return value === "NBA" || value === "WNBA" || value === "NFL" || value === "LALIGA" || value === "MLB";
}
