...
export const DEPLOY_DEFERRED = new Map([
  // ✅ CLEARED 2026-09-24 (Cowork cloud, under Trevor's delegation), both
  // byte-verified on readback: `sync-nba-projections` v53 and
  // `compute-topshot-pack-ev` v72. The deploy tool decodes `\uXXXX` escapes in
  // transit, so v52 of sync-nba-projections shipped two raw combining characters
