...
export default function FastBreakClient() {
  ...
  // ⚠ NULL, NOT 0. `?? 0` published "0.00 FP" as the Total Projected — a number the
  // optimizer never produced — directly ABOVE the "couldn't load" line, so the page said
  // both at once and the figure is the louder of the two (44px, brand red). A collector
