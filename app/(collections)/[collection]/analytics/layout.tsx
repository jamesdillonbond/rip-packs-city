...
export async function generateMetadata(
  ...
  if (!collection) return unknownCollectionMetadata("analytics", id)
  return pageMetadata("analytics", collection.label, collection.id)
}
...
export default async function AnalyticsLayout(props: {
  children: ReactNode
