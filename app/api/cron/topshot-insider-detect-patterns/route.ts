// app/api/cron/topshot-insider-detect-patterns/route.ts
//
// Cron entrypoint for Insider Signals pattern detection. Schedule on
// cron-job.org every 30 minutes. Reads topshot_insider_buybacks over
// the last 24h and fires alerts on cluster_buyback /
// set_concentration / low_serial_buyback patterns.
...
export async function GET(req: NextRequest) {
  ...
  try {
    const res = await fetch(`${SUPABASE_URL}/functions/v1/topshot-insider-detect-patterns`, {
      method: "POST",
      headers: {
