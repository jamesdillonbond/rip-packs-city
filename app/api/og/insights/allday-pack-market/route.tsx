// app/api/og/insights/allday-pack-market/route.tsx
//
// Open Graph card for /insights/allday-pack-market. 1200x630 PNG via next/og.
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const r = await ogFetch(`${origin}/api/public/insights/allday-pack-market`, { cache: "no-store" })
    if (r.ok) {
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: 18, color: "rgba(255,255,255,0.55)" }}>
          ...
          <div style={{ display: "flex" }}>rippackscity.com/insights/allday-pack-market</div>
        </div>
      </div>
    ),
