    ...
    <div style={{ minHeight: "100vh", background: "var(--rpc-black)", color: "var(--rpc-text-primary)", fontFamily: "var(--font-display)", padding: "40px 24px" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 12, fontFamily: "monospace", color: "var(--rpc-text-secondary)", letterSpacing: "0.05em" }}>{wallet}</div>
        </div>
        ...
        {intel && intel.ts_moments > 0 ? (
          <div style={{ marginBottom: 32 }}>
            <div style={{ fontSize: 14, letterSpacing: "0.15em", color: "var(--rpc-text-secondary)", marginBottom: 12, textTransform: "uppercase" }}>
            ...
            >
              <span style={{ padding: "8px 14px", border: "1px solid var(--rpc-border)", borderRadius: 999, background: "var(--rpc-surface)", color: "var(--rpc-text-secondary)" }}>
                    ...
                    >
                      ...
                      <div style={{ padding: "10px 12px" }}>
                        <div style={{ display: "flex", gap: 4, marginBottom: 6, flexWrap: "wrap" }}>
                          {h.is_rookie ? (
                            // brand-exception: dark text on the gold ROOKIE badge — theme-independent
                          ...
                          {h.is_trophy ? (
                            // brand-exception: white text on the red TROPHY badge — theme-independent
                        ...
                        <div style={{ fontSize: 11, color: "var(--rpc-text-secondary)", fontFamily: "var(--font-mono, monospace)", marginTop: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                          {h.set_name ?? ""}
                        </div>
                        {squeeze != null ? (
                          <div style={{ marginTop: 8 }}>
                            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 9, color: "var(--rpc-text-muted)", fontFamily: "var(--font-mono, monospace)", marginBottom: 2 }}>
                              <span>SQUEEZE</span>
                              <span>{squeeze.toFixed(0)}%</span>
                            </div>
                            <div style={{ width: "100%", height: 4, background: "var(--rpc-surface-hover)", borderRadius: 2, overflow: "hidden" }}>
        ...
        {(data.perCollection ?? []).length > 1 ? (
          <div style={{ marginBottom: 32 }}>
            <div style={{ fontSize: 14, letterSpacing: "0.15em", color: "var(--rpc-text-secondary)", marginBottom: 16, textTransform: "uppercase" }}>Across Flow Collections</div>
            <div style={{ display: "grid", gridTemplateColumns: `repeat(${Math.min(data.perCollection.length, 5)}, minmax(0, 1fr))`, gap: 12 }}>
              {data.perCollection.map((c) => (
                <div key={c.slug} style={{ border: "1px solid var(--rpc-border)", borderRadius: 8, background: "var(--rpc-surface)", padding: "14px 12px", textAlign: "center" }}>
        ...
        {/* Top 5 moments */}
        <div style={{ marginBottom: 32 }}>
          <div style={{ fontSize: 14, letterSpacing: "0.15em", color: "var(--rpc-text-secondary)", marginBottom: 16, textTransform: "uppercase" }}>Top Moments by FMV</div>
        ...
        >
          ...
          <div style={{ fontSize: 16, color: "var(--rpc-text-secondary)", lineHeight: 1.5, maxWidth: 540, margin: "0 auto 16px" }}>
        ...
        {/* Footer */}
        <div style={{ textAlign: "center", borderTop: "1px solid var(--rpc-border)", paddingTop: 24 }}>
          <div style={{ fontSize: 12, fontFamily: "monospace", color: "var(--rpc-text-muted)", letterSpacing: "0.1em" }}>rippackscity.com</div>
        </div>
      </div>
    </div>
  )
