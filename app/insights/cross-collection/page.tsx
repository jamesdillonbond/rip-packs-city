...
//
// Public Cross-Collection Whale Map. No auth. Per the 2026-05-29 research
// integration: 143 wallets hold 3+ Flow collections — "RPC's natural
// intelligence-product audience." Top Shot's site has no way to surface
// a cohort that crosses collection boundaries. We do.
...
export default function CrossCollectionPage() {
...
.rpc-cc-wallet-link { text-decoration: none; color: inherit; display: flex; align-items: center; gap: 10px; }
