...
// app/insights/pinnacle-scarcity/PinnacleScarcityBoardClient.tsx
//
...
export default function PinnacleScarcityBoardClient({ initialRows, initialFetchedAt }: Props) {
  ...
  useEffect(() => {
    if (isFirstRun.current) {
      ...
      if (sort === "scarcity" && franchise === "ALL" && !chasersOnly) return
    }
