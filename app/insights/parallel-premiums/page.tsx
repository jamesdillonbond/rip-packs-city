...
async function fetchInitialRows(): Promise<{ rows: ParallelRow[]; fetchedAt: string }> {
...
export default async function ParallelPremiumsPage() {
  ...
  return <ParallelPremiumsBoardClient initialRows={rows} initialFetchedAt={fetchedAt} />
}
