...
//
// Surface G — Top Shot per-set squeeze leaderboard. Drill-down companion to
// Surface A. Where the squeeze board ranks individual editions, this view
// rolls up to whole sets — answering "if I'm completing this set, how
// scarce will it actually be?"
//
// Data: GET /api/public/insights/set-squeeze → reads the
// topshot_set_squeeze_board view shipped 2026-05-30 (efa5e94).
...
export default function SetSqueezePage() {
