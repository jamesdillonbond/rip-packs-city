...
- 📝 **Owed:** the 8 pinned legs + 34 other functions (one deliberate migration, three-file discipline for the pinned ones) and a repo guard against new `WHEN OTHERS` in timeout-claiming functions.
