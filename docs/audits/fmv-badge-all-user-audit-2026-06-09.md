...
- **Writer fixes + badge catalog-walk + display fixes + tree cleanup** → [docs/handoff-2026-06-10-fmv-badge-audit-fixes.md](../handoff-2026-06-10-fmv-badge-audit-fixes.md) (Claude Code, Items 0-7).
