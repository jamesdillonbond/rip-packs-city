...
--   * candidate ranking: most team-matching editions, then is_active, then has-
--     headshot, then id (the tie-break ladder that disambiguates a shared name);
...
-- matching editions, p2 (Bucks) has none -> ranking must pick p1.
...
INSERT INTO public.editions (id, collection_id, player_id, player_name, team_name, circulation_count, first_minted_at) VALUES
  ('e1111111-1111-1111-1111-111111111111'::uuid, :TS::uuid, :p1::uuid, 'Damian Lillard', 'Trail Blazers', 100, now()-interval '10 days'),
  ('e2222222-2222-2222-2222-222222222222'::uuid, :TS::uuid, :p1::uuid, 'Damian Lillard', 'Trail Blazers',  50, now()-interval '2 days');
...
-- ── 2. ambiguous slug: picks p1 (more team-matching editions) ────────────────
