...
-- anon-exec: unchanged — public.get_series_rollups is SECURITY DEFINER and already revoked from PUBLIC, anon and authenticated (verified live 2026-08-24 by has_function_privilege).
--
