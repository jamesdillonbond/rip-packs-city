-- 2026-09-26 (PT) — get_wallet_pack_summary v12: the history's All Day changes
-- (20260926210100): drop dates from allday_drop_windows where
-- pack_distributions carries none, and a REWARD-typed All Day distribution is
-- $0 (recorded primary buys and inferred acquisitions alike).
