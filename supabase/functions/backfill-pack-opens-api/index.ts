...
// During a key rotation, set PACK_OPENS_API_GATE_KEY_OLD to the OUTGOING key: both are then accepted, so the
...
const GATE_OLD = Deno.env.get("PACK_OPENS_API_GATE_KEY_OLD") ?? ""
