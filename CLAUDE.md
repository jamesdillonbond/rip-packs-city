...
- **The one measured-but-unshipped DB fix is LOW-STAKES** (numbers: [roadmap-status.md](docs/reference/roadmap-status.md)). ⭐ Another stated blocker was itself a MEASUREMENT — **re-read a "blocked" item's blocker before inheriting it.**
