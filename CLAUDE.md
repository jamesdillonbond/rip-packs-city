...
### June 21, 2026 (daytime, Claude Code) — the "F1-F3 mis-key" residual is actually a platform-wide, ongoing TS sales mis-attribution bug; remediated the tracked portion (9,336 sales + 2,842 moments re-keyed to on-chain truth)
