...
- ⚠ **Displaced 09-20 (verbatim, end of file): `count(*)` over a ONE-ROW function → database.md · Diff the SET, not the count → trust-board-and-safety.md.**
