...
- `get_runtime_logs`: `environment: "production"` + short windows; `console.warn` is NOT indexed — use `console.log`. ⚠ `get_runtime_errors` `routes=`/`users=` are SMEARED — re-group on `requestPath`.
