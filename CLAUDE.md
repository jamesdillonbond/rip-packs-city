...
- `docs/sessions/2026-07.md` — July 25 → July 1 (overnight passes + daytime CC; Candy chain-two productization/parity, sales-counterparty/Panini readiness, Pack-EV accuracy program, IOPS read-diet, Trophy-case PDF, test-coverage infra, platform audits).
