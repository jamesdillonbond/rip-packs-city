...
**Solana / Candy Digital (in prep):** its OWN readiness trigger is still ≥30 days of Candy Solana sales history (earliest 2026-07-08) + a defined edition/serial schema RPC can index (chain-abstraction Phases A-F already complete). This gate is Candy-specific and does NOT gate other segments. **Drop 1 (2026 MLB Base Series ICONs, $10/pack, 500 packs) confirmed for Jul 17 2026, 10 AM PT.** The Helius proxy secrets are LIVE (operator gate closed 07-16; DAS verified end-to-end), and Trevor's Candy Solana wallet `63p1oKqkAQ9sQD55iApNRkVL2XzYtASwKjCdSSNEGEhY` is the Item-0 discovery tripwire (any activity = Candy minting = run discovery).
