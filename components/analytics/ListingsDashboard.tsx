...
export default function ListingsDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        <div className="mb-3">
          <h2 className="text-lg font-semibold text-slate-100">Open loan offers</h2>
          <p className="text-xs text-slate-500">Liquidity awaiting borrowers across all collections</p>
        </div>
      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
          <div>
            <h3 className="text-sm font-semibold text-slate-100">Top 25 open offers</h3>
            <p className="text-xs text-slate-500">{sortOption.caption}</p>
          </div>
          <div className="relative flex-shrink-0">
            ...
            {sortOpen ? (
              <div
                className="absolute right-0 top-full mt-1 z-20 w-56 rounded-md border border-slate-700 bg-slate-900 shadow-xl"
                ...
                (offers?.rows ?? []).map((row, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-2 pr-3 text-right text-slate-100 font-semibold tabular-nums">
                      ...
                      <td className="py-2 pr-0 text-right">
                        {url ? (
                          <a
                            ...
                            className="inline-flex items-center gap-1 rounded border border-slate-700 px-2 py-1 text-[10px] uppercase tracking-wider font-semibold text-slate-300 hover:border-emerald-500/40 hover:text-emerald-400 transition-colors"
                          >
                            Flowty
      ...
      <section>
        <div className="mb-3">
          <h2 className="text-lg font-semibold text-slate-100">Top Shot orderbook</h2>
          <p className="text-xs text-slate-500">Periodic sample of marketplace ask depth</p>
        </div>
      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
        <div className="mb-3">
          <h3 className="text-sm font-semibold text-slate-100">Marketplace listings (Sniper sampled)</h3>
          <p className="text-xs text-slate-500">
            Per-collection ask snapshots from the deal-feed scanner
          </p>
        </div>

        <div className="rounded-lg border border-slate-800 bg-slate-950/40 p-3 flex items-start gap-2 mb-4">
              ...
              {marketplace.length === 0 ? (
                ...
                marketplace.map((row) => {
                  ...
                  return (
                    ...
                    >
                      <td className="py-2 pr-3">
                        <span className="text-slate-100 font-medium">{collectionLabel}</span>
                        {sparse ? (
                      ...
                      <td className="py-2 pr-0 text-right text-slate-400 tabular-nums">
      ...
      {summary?.data_caveats && summary.data_caveats.length > 0 ? (
        <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
          ...
          {showCaveats ? (
            <ul className="mt-3 space-y-1.5 text-xs text-slate-400 leading-relaxed list-disc pl-4">
