  ...
  return (
    <div className="rounded-xl border border-[color:var(--rpc-border)] bg-[var(--rpc-surface)] flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-[color:var(--rpc-border)]">
        <div>
          <h3 className="font-semibold text-[color:var(--rpc-text-primary)]">{TITLE[role]}</h3>
                    ...
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <Link
                          ...
                          className="text-[color:var(--rpc-text-secondary)] truncate hover:text-emerald-400 transition-colors block"
                          title={r.addr}
                        >
                          {display}
                        </Link>
