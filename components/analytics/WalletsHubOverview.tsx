...
export default function WalletsHubOverview() {
  ...
  if (loading && !data) {
    return (
      <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 text-center text-sm text-slate-500">
  ...
  return (
    <section className="space-y-6">
      <div className="flex items-end justify-between">
        <div>
          <h2 className="text-lg font-semibold text-slate-100">Wallets hub</h2>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
        ...
        {totalSegments > 0 ? (
          <>
            <div className="flex h-3 w-full overflow-hidden rounded border border-slate-800">
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
              {(["whale", "active", "casual", "dust"] as const).map((k) => {
                ...
                return (
                  <div
                    key={k}
                    className="flex items-start gap-2 rounded-md border border-slate-800 bg-slate-950/40 p-2.5"
                  >
                    <span
          ...
          <div className="text-sm text-slate-500">No segment data available.</div>
        )}
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
          <div className="flex items-baseline justify-between mb-3">
            <h3 className="text-sm font-semibold text-slate-100">Role split</h3>
          ...
          <div className="mt-3 flex items-start gap-2 rounded-md border border-slate-800 bg-slate-950/40 p-2.5">
